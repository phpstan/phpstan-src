...
phpstan:
	php bin/phpstan clear-result-cache -q && php -d memory_limit=559M bin/phpstan -v

phpstan-result-cache:
	php -d memory_limit=559M bin/phpstan

phpstan-fix:
	php -d memory_limit=559M bin/phpstan --fix

phpstan-generate-baseline:
	php -d memory_limit=559M bin/phpstan --generate-baseline

phpstan-generate-baseline-php:
	php -d memory_limit=559M bin/phpstan analyse --generate-baseline phpstan-baseline.php

phpstan-pro:
	php -d memory_limit=559M bin/phpstan --pro

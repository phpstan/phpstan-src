...
php;
		...
		// The turbo extension declares these classes natively when
		// TurboExtensionEnabler activates it right after the autoloader
		...
		// the autoloader.
		$manifestContents = file_get_contents($root . '/vendor/turbo-shadowed-classes.json');
		if ($manifestContents === false) {
			throw new ShouldNotHappenException('Could not read vendor/turbo-shadowed-classes.json — generated by build/generate-turbo-manifest.php on composer dump-autoload');
		}

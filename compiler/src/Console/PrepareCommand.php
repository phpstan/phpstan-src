...
php;
		...
		if ($manifestContents === false) {
			throw new ShouldNotHappenException('Could not read vendor/turbo-shadowed-classes.json — generated by build/generate-turbo-stubs.php on composer dump-autoload');
		}

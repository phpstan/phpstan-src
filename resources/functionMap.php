...
'RedisArray::hscan' => ['array<string, string>|false', 'key'=>'string', '&iterator'=>'?int', 'pattern='=>'?string', 'count='=>'int'],
'RedisArray::info' => ['array<string, array<string, mixed>>|false'],
'RedisArray::keys' => ['array<string, list<string>>|false', 'pattern'=>'string'],
'RedisArray::mget' => ['list<mixed>|false', 'keys'=>'string[]'],
'RedisArray::scan' => ['list<string>|false', '&iterator'=>'?int', 'node'=>'string', 'pattern='=>'?string', 'count='=>'?int'],
'RedisArray::sscan' => ['list<string>|false', 'key'=>'string', '&iterator'=>'?int', 'pattern='=>'?string', 'count='=>'int'],
'RedisArray::zscan' => ['array<string, float>|false', 'key'=>'string', '&iterator'=>'?int', 'pattern='=>'?string', 'count='=>'int'],

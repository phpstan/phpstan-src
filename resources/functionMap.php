...
'Redis::__construct' => ['void', 'options='=>'?array{host?:string,port?:int,connectTimeout?:float,retryInterval?:int,readTimeout?:float,persistent?:bool|string,database?:int,maxRetries?:int,auth?:list{string|null|false,string}|list{string}|string,ssl?:array<string, mixed>,backoff?:array<string, mixed>}'],

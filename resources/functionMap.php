...
'array_count_values' => ['array<positive-int>', 'input'=>'array<int|string>'],
...
'Locale::getPrimaryLanguage' => ['string|null', 'locale'=>'string'],
...
'locale_get_primary_language' => ['string|null', 'locale'=>'string'],
...
'Redis::geodist' => ['__benevolent<Redis|float|false>', 'key'=>'string', 'src'=>'string', 'dst'=>'string', 'unit='=>'?string'],
...
'Redis::georadiusbymember' => ['__benevolent<Redis|array<int,mixed>>', 'key'=>'string', 'member'=>'string', 'radius'=>'float', 'unit'=>'string', 'options='=>'array<string,mixed>'],
'Redis::georadiusbymember_ro' => ['__benevolent<Redis|array<int,mixed>>', 'key'=>'string', 'member'=>'string', 'radius'=>'float', 'unit'=>'string', 'options='=>'array<string,mixed>'],
...
'Redis::hSet' => ['__benevolent<Redis|int|false>', 'key'=>'string', '...fields_and_vals='=>'mixed'],
'Redis::hSetNx' => ['__benevolent<Redis|bool>', 'key'=>'string', 'field'=>'string', 'value'=>'mixed'],
...
'RedisArray::__construct' => ['void', 'name_or_hosts'=>'string|array<int, string>', 'options='=>'?array<string, mixed>'],
...
'RedisArray::hscan' => ['__benevolent<array<string, string>|false>', 'key'=>'string', '&iterator'=>'?int', 'pattern='=>'?string', 'count='=>'int'],
'RedisArray::info' => ['__benevolent<array<string, array<string, mixed>>|false>'],
'RedisArray::keys' => ['__benevolent<array<string, list<string>>|false>', 'pattern'=>'string'],
'RedisArray::mget' => ['__benevolent<list<mixed>|false>', 'keys'=>'string[]'],
'RedisArray::scan' => ['__benevolent<list<string>|false>', '&iterator'=>'?int', 'node'=>'string', 'pattern='=>'?string', 'count='=>'?int'],
'RedisArray::sscan' => ['__benevolent<list<string>|false>', 'key'=>'string', '&iterator'=>'?int', 'pattern='=>'?string', 'count='=>'int'],
'RedisArray::zscan' => ['__benevolent<array<string, float>|false>', 'key'=>'string', '&iterator'=>'?int', 'pattern='=>'?string', 'count='=>'int'],
...
'RedisCluster::bitCount' => ['int', 'key'=>'string', 'start='=>'int', 'end='=>'int', 'bybit='=>'bool'],
'RedisCluster::bitOp' => ['int', 'operation'=>'string', 'deskey'=>'string', 'srckey'=>'string', '...otherkeys='=>'string'],
'RedisCluster::bitpos' => ['int', 'key'=>'string', 'bit'=>'int', 'start='=>'int', 'end='=>'int', 'bybit='=>'bool'],
'RedisCluster::blPop' => ['array', 'keys'=>'array', 'timeout'=>'int', '...extra_args='=>'mixed'],
'RedisCluster::brPop' => ['array', 'keys'=>'array', 'timeout'=>'int', '...extra_args='=>'mixed'],
'RedisCluster::brpoplpush' => ['string', 'srcKey'=>'string', 'dstKey'=>'string', 'timeout'=>'int'],
'RedisCluster::client' => ['', 'key_or_address'=>'string|array', 'subcommand'=>'', 'arg='=>''],
'RedisCluster::close' => [''],
...
'RedisCluster::config' => ['array', 'key_or_address'=>'string|array', 'subcommand'=>'string', '...extra_args='=>'mixed'],
'RedisCluster::dbSize' => ['int', 'nodeParams'=>'string'],
'RedisCluster::decr' => ['int', 'key'=>'string', 'by='=>'int'],
'RedisCluster::decrBy' => ['int', 'key'=>'string', 'value'=>'int'],
'RedisCluster::del' => ['int', 'key'=>'string[]|string', '...other_keys='=>'string'],
...
'RedisCluster::exists' => ['bool', 'key'=>'string', '...other_keys='=>'mixed'],
'RedisCluster::expire' => ['bool', 'key'=>'string', 'ttl'=>'int', 'mode='=>'string|null'],
'RedisCluster::expireAt' => ['bool', 'key'=>'string', 'timestamp'=>'int', 'mode='=>'string|null'],
'RedisCluster::flushAll' => ['bool', 'nodeParams'=>'string', 'async='=>'bool'],
'RedisCluster::flushDB' => ['bool', 'nodeParams'=>'string', 'async='=>'bool'],
'RedisCluster::geoAdd' => ['', 'key'=>'string', 'longitude'=>'float', 'latitude'=>'float', 'member'=>'string', '...other_triples_and_options='=>'mixed'],
'RedisCluster::geoDist' => ['', 'key'=>'string', 'member1'=>'string', 'member2'=>'string', 'unit='=>'string'],
'RedisCluster::geohash' => ['', 'key'=>'', 'member'=>'', '...other_members='=>'string'],
'RedisCluster::geopos' => ['', 'key'=>'', 'member'=>'', '...other_members='=>'string'],
'RedisCluster::geoRadius' => ['', 'key'=>'string', 'lng'=>'float', 'lat'=>'float', 'radius'=>'float', 'unit'=>'string', 'options='=>'array'],
'RedisCluster::geoRadiusByMember' => ['', 'key'=>'string', 'member'=>'string', 'radius'=>'float', 'unit'=>'string', 'options='=>'array'],
...
'RedisCluster::hDel' => ['int', 'key'=>'string', 'member'=>'string', '...other_members='=>'string'],
...
'RedisCluster::hSet' => ['int', 'key'=>'string', 'hashKey'=>'string', 'value'=>'mixed'],
'RedisCluster::hSetNx' => ['bool', 'key'=>'string', 'hashKey'=>'string', 'value'=>'mixed'],
'RedisCluster::hVals' => ['array', 'key'=>'string'],
'RedisCluster::incr' => ['int', 'key'=>'string', 'by='=>'int'],
'RedisCluster::incrBy' => ['int', 'key'=>'string', 'value'=>'int'],
'RedisCluster::incrByFloat' => ['float', 'key'=>'string', 'increment'=>'float'],
'RedisCluster::info' => ['string', 'key_or_address'=>'string|array', '...sections='=>'string'],
...
'RedisCluster::lPop' => ['string', 'key'=>'string', 'count='=>'int'],
'RedisCluster::lPush' => ['int', 'key'=>'string', 'value'=>'mixed', '...other_values='=>'mixed'],
...
'RedisCluster::object' => ['string', 'subcommand'=>'string', 'key'=>'string'],
'RedisCluster::persist' => ['bool', 'key'=>'string'],
'RedisCluster::pExpire' => ['bool', 'key'=>'string', 'ttl'=>'int', 'mode='=>'string|null'],
'RedisCluster::pExpireAt' => ['bool', 'key'=>'string', 'timestamp'=>'int', 'mode='=>'string|null'],
...
'RedisCluster::ping' => ['string', 'nodeParams'=>'string', 'message='=>'string|null'],
...
'RedisCluster::pubsub' => ['array', 'key_or_address'=>'string|array', '...values='=>'string'],
'RedisCluster::punSubscribe' => ['', 'pattern'=>'string', '...other_patterns='=>'string'],
...
'RedisCluster::rPop' => ['string', 'key'=>'string', 'count='=>'int'],
'RedisCluster::rpoplpush' => ['string', 'srcKey'=>'string', 'dstKey'=>'string'],
'RedisCluster::rPush' => ['int', 'key'=>'string', '...elements='=>'mixed'],
'RedisCluster::rPushx' => ['int', 'key'=>'string', 'value'=>'string'],
'RedisCluster::sAdd' => ['int', 'key'=>'string', 'value'=>'mixed', '...other_values='=>'mixed'],
...
'RedisCluster::sDiff' => ['list<string>', 'key'=>'string', '...other_keys='=>'string'],
...
'RedisCluster::sInterStore' => ['int', 'key'=>'string', '...other_keys='=>'string'],
'RedisCluster::sIsMember' => ['bool', 'key'=>'string', 'value'=>'string'],
'RedisCluster::slowLog' => ['', 'key_or_address'=>'string|array', '...args='=>'mixed'],
...
'RedisCluster::sPop' => ['string', 'key'=>'string', 'count='=>'int'],
...
'RedisCluster::unSubscribe' => ['', 'channels'=>''],
...
'RedisCluster::xclaim' => ['', 'key'=>'string', 'group'=>'string', 'consumer'=>'string', 'min_iddle'=>'', 'ids'=>'array', 'options'=>'array'],
'RedisCluster::xdel' => ['', 'str_key'=>'string', 'arr_ids'=>'array'],
'RedisCluster::xgroup' => ['', 'str_operation'=>'string', 'str_key='=>'string', 'str_arg1='=>'', 'str_arg2='=>'', 'str_arg3='=>'', 'entries_read='=>'int'],
'RedisCluster::xinfo' => ['', 'str_cmd'=>'string', 'str_key='=>'string', 'str_group='=>'string', 'count='=>'int'],
...
'RedisCluster::xtrim' => ['', 'str_key'=>'string', 'i_maxlen'=>'', 'boo_approximate='=>'', 'minid='=>'bool', 'limit='=>'int'],
'RedisCluster::zAdd' => ['int', 'key'=>'string', 'score_or_options'=>'array|float', '...more_scores_and_mems='=>'mixed'],
...
'RedisCluster::zRange' => ['array', 'key'=>'string', 'start'=>'int', 'end'=>'int', 'options='=>'array|bool|null'],
...
'RedisCluster::zRevRange' => ['array', 'key'=>'string', 'min'=>'int', 'max'=>'int', 'options='=>'array|null'],
'RedisCluster::zRevRangeByLex' => ['array', 'key'=>'string', 'min'=>'int', 'max'=>'int', 'options='=>'array|null'],
...
'SQLite3Result::columnName' => ['false|string', 'column_number'=>'int'],
'SQLite3Result::columnType' => ['false|int', 'column_number'=>'int'],
...
'xdebug_start_gcstats' => ['string|false', 'gcstats_file='=>'?string'],
'xdebug_start_trace' => ['string|null', 'trace_file='=>'?string', 'options='=>'int'],

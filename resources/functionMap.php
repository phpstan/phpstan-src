...
'class_implements' => ['array<string,class-string>|false', 'what'=>'object|string', 'autoload='=>'bool'],
...
'fputcsv' => ['0|positive-int|false', 'fp'=>'resource', 'fields'=>'array<int|string, string|stringable-object|int|float|bool|null>', 'delimiter='=>'string', 'enclosure='=>'string', 'escape_char='=>'string'],
...
'printf' => ['int', 'format'=>'string', '...values='=>'string|stringable-object|int|float|bool|null'],
...
'sprintf' => ['string', 'format'=>'string', '...values='=>'string|stringable-object|int|float|bool|null'],

...
'RedisCluster::_prefix' => ['__benevolent<bool|string>', 'value'=>'string'],
'RedisCluster::_redir' => ['__benevolent<string|null>'],
'RedisCluster::_serialize' => ['__benevolent<bool|string>', 'value'=>'mixed'],
...
'RedisCluster::append' => ['__benevolent<RedisCluster|bool|int>', 'key'=>'string', 'value'=>'mixed'],
'RedisCluster::bgrewriteaof' => ['__benevolent<RedisCluster|bool>', 'key_or_address'=>'string|array'],
'RedisCluster::bgsave' => ['__benevolent<RedisCluster|bool>', 'key_or_address'=>'string|array'],
'RedisCluster::bitCount' => ['__benevolent<RedisCluster|bool|int>', 'key'=>'string', 'start='=>'int', 'end='=>'int', 'bybit='=>'bool'],
'RedisCluster::bitOp' => ['__benevolent<RedisCluster|bool|int>', 'operation'=>'string', 'deskey'=>'string', 'retkey'=>'string', '...otherkeys='=>'string'],
'RedisCluster::bitpos' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'bit'=>'bool', 'start='=>'int', 'end='=>'int', 'bybit='=>'bool'],
'RedisCluster::blmove' => ['__benevolent<Redis|string|false>', 'src'=>'string', 'dst'=>'string', 'wherefrom'=>'string', 'whereto'=>'string', 'timeout'=>'float'],
'RedisCluster::blmpop' => ['__benevolent<RedisCluster|array|null|false>', 'timeout'=>'float', 'keys'=>'array', 'from'=>'string', 'count='=>'int'],
'RedisCluster::blPop' => ['__benevolent<RedisCluster|array|null|false>', 'key'=>'string|array', 'timeout_or_key'=>'string|float|int', '...extra_args='=>'mixed'],
'RedisCluster::brPop' => ['__benevolent<RedisCluster|array|null|false>', 'key'=>'string|array', 'timeout_or_key'=>'string|float|int', '...extra_args='=>'mixed'],
'RedisCluster::brpoplpush' => ['mixed', 'srckey'=>'string', 'deskey'=>'string', 'timeout'=>'int'],
'RedisCluster::bzmpop' => ['__benevolent<RedisCluster|array|null|false>', 'timeout'=>'float', 'keys'=>'array', 'from'=>'string', 'count='=>'int'],
'RedisCluster::bzpopmax' => ['array', 'key'=>'string|array', 'timeout_or_key'=>'string|int', '...extra_args='=>'mixed'],
'RedisCluster::bzpopmin' => ['array', 'key'=>'string|array', 'timeout_or_key'=>'string|int', '...extra_args='=>'mixed'],
'RedisCluster::clearlasterror' => ['bool'],
'RedisCluster::cleartransferredbytes' => ['void'],
'RedisCluster::client' => ['__benevolent<array|string|bool>', 'key_or_address'=>'string|array', 'subcommand'=>'string', 'arg='=>'string|null'],
'RedisCluster::close' => ['bool'],
'RedisCluster::cluster' => ['mixed', 'key_or_address'=>'string|array', 'command'=>'string', '...extra_args='=>'mixed'],
'RedisCluster::command' => ['mixed', '...extra_args='=>'mixed'],
'RedisCluster::config' => ['mixed', 'key_or_address'=>'string|array', 'subcommand'=>'string', '...extra_args='=>'mixed'],
'RedisCluster::copy' => ['__benevolent<RedisCluster|bool>', 'src'=>'string', 'dst'=>'string', 'options='=>'array|null'],
'RedisCluster::dbSize' => ['__benevolent<RedisCluster|int>', 'key_or_address'=>'string|array'],
'RedisCluster::decr' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string','by='=>'int'],
'RedisCluster::decrBy' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'value'=>'int'],
'RedisCluster::decrbyfloat' => ['float', 'key'=>'string', 'value'=>'float'],
'RedisCluster::del' => ['__benevolent<RedisCluster|int|false>', 'key'=>'array|string', '...other_keys='=>'string'],
'RedisCluster::delifeq' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'value'=>'mixed'],
'RedisCluster::discard' => ['bool'],
'RedisCluster::dump' => ['__benevolent<RedisCluster|string|false>', 'key'=>'string'],
'RedisCluster::echo' => ['__benevolent<RedisCluster|string|false>', 'key_or_address'=>'string|array', 'msg'=>'string'],
...
'RedisCluster::evalsha_ro' => ['mixed', 'script_sha'=>'string', 'args='=>'array', 'num_keys='=>'int'],
'RedisCluster::exec' => ['__benevolent<array|false>'],
'RedisCluster::exists' => ['__benevolent<RedisCluster|int|bool>', 'key'=>'mixed', '...other_keys='=>'mixed'],
'RedisCluster::expire' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'timeout'=>'int', 'mode='=>'string|null'],
'RedisCluster::expireAt' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'timestamp'=>'int', 'mode='=>'string|null'],
'RedisCluster::expiremember' => ['__benevolent<Redis|int|false>', 'key'=>'string', 'field'=>'string', 'ttl'=>'int', 'unit='=>'string|null'],
'RedisCluster::expiretime' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::flushAll' => ['__benevolent<RedisCluster|bool>', 'key_or_address'=>'string|array', 'async='=>'bool'],
'RedisCluster::flushDB' => ['__benevolent<RedisCluster|bool>', 'key_or_address'=>'string|array', 'async='=>'bool'],
'RedisCluster::geoAdd' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'lng'=>'float', 'lat'=>'float', 'member'=>'string', '...other_triples_and_options='=>'mixed'],
'RedisCluster::geoDist' => ['__benevolent<RedisCluster|float|false>', 'key'=>'string', 'src'=>'string', 'dest'=>'string', 'unit='=>'string|null'],
'RedisCluster::geohash' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'member'=>'string', '...other_members='=>'string'],
'RedisCluster::geopos' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'member'=>'string', '...other_members='=>'string'],
'RedisCluster::geoRadius' => ['mixed', 'key'=>'string', 'lng'=>'float', 'lat'=>'float', 'radius'=>'float', 'unit'=>'string', 'options='=>'array'],
'RedisCluster::georadius_ro' => ['mixed', 'key'=>'string', 'lng'=>'float', 'lat'=>'float', 'radius'=>'float', 'unit'=>'string', 'options='=>'array'],
'RedisCluster::geoRadiusByMember' => ['mixed', 'key'=>'string', 'member'=>'string', 'radius'=>'float', 'unit'=>'string', 'options='=>'array'],
'RedisCluster::georadiusbymember_ro' => ['mixed', 'key'=>'string', 'member'=>'string', 'radius'=>'float', 'unit'=>'string', 'options='=>'array'],
'RedisCluster::geosearch' => ['__benevolent<RedisCluster|array>', 'key'=>'string', 'position'=>'array|string', 'shape'=>'array|int|float', 'unit'=>'string', 'options='=>'array'],
'RedisCluster::geosearchstore' => ['__benevolent<RedisCluster|array|int|false>', 'dst'=>'string', 'src'=>'string', 'position'=>'array|string', 'shape'=>'array|int|float', 'unit'=>'string', 'options='=>'array'],
'RedisCluster::get' => ['mixed', 'key'=>'string'],
'RedisCluster::getWithMeta' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string'],
'RedisCluster::getBit' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'value'=>'int'],
'RedisCluster::getdel' => ['mixed', 'key'=>'string'],
'RedisCluster::getex' => ['__benevolent<RedisCluster|string|false>', 'key'=>'string', 'options='=>'array'],
'RedisCluster::getLastError' => ['__benevolent<string|null>'],
'RedisCluster::getmode' => ['int'],
'RedisCluster::getOption' => ['mixed', 'option'=>'int'],
'RedisCluster::getRange' => ['__benevolent<RedisCluster|string|false>', 'key'=>'string', 'start'=>'int', 'end'=>'int'],
'RedisCluster::getSet' => ['__benevolent<RedisCluster|string|bool>', 'key'=>'string', 'value'=>'mixed'],
'RedisCluster::hDel' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'member'=>'string', '...other_members='=>'string'],
'RedisCluster::hExists' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'member'=>'string'],
'RedisCluster::hexpire' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'ttl'=>'int', 'fields'=>'array', 'mode='=>'string|null'],
'RedisCluster::hexpireat' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'ttl'=>'int', 'fields'=>'array', 'mode='=>'string|null'],
'RedisCluster::hexpiretime' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'fields'=>'array'],
'RedisCluster::hGet' => ['mixed', 'key'=>'string', 'member'=>'string'],
'RedisCluster::hGetAll' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string'],
'RedisCluster::hgetex' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'fields'=>'array', 'expiry='=>'string|array|null'],
'RedisCluster::hIncrBy' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'member'=>'string', 'value'=>'int'],
'RedisCluster::hIncrByFloat' => ['__benevolent<RedisCluster|float|false>', 'key'=>'string', 'member'=>'string', 'value'=>'float'],
'RedisCluster::hKeys' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string'],
'RedisCluster::hLen' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::hMGet' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'keys'=>'array'],
'RedisCluster::hMSet' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'key_values'=>'array'],
'RedisCluster::hScan' => ['__benevolent<array|bool>', 'key'=>'string', '&iterator'=>'null|int|string', 'pattern='=>'string|null', 'count='=>'int'],
'RedisCluster::hpersist' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'fields'=>'array'],
'RedisCluster::hpexpire' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'ttl'=>'int', 'fields'=>'array', 'mode='=>'string|null'],
'RedisCluster::hpexpireat' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'mstime'=>'int', 'fields'=>'array', 'mode='=>'string|null'],
'RedisCluster::hpexpiretime' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'fields'=>'array'],
'RedisCluster::hpttl' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'fields'=>'array'],
'RedisCluster::hrandfield' => ['__benevolent<RedisCluster|string|array>', 'key'=>'string', 'options='=>'array|null'],
'RedisCluster::hSet' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'member'=>'string', 'value'=>'mixed'],
'RedisCluster::hsetex' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'fields'=>'array', 'expiry='=>'array|null'],
'RedisCluster::hSetNx' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'member'=>'string', 'value'=>'mixed'],
'RedisCluster::hstrlen' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'field'=>'string'],
'RedisCluster::httl' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'fields'=>'array'],
'RedisCluster::hVals' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string'],
'RedisCluster::incr' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'by='=>'int'],
'RedisCluster::incrBy' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'value'=>'int'],
'RedisCluster::incrByFloat' => ['__benevolent<RedisCluster|float|false>', 'key'=>'string', 'value'=>'float'],
'RedisCluster::info' => ['__benevolent<RedisCluster|array|false>', 'key_or_address'=>'string|array', '...sections='=>'string'],
'RedisCluster::keys' => ['__benevolent<RedisCluster|array|false>', 'pattern'=>'string'],
'RedisCluster::lastSave' => ['__benevolent<RedisCluster|int|false>', 'key_or_address'=>'string|array'],
'RedisCluster::lGet' => ['__benevolent<RedisCluster|string|bool>', 'key'=>'string', 'index'=>'int'],
'RedisCluster::lIndex' => ['mixed', 'key'=>'string', 'index'=>'int'],
'RedisCluster::lInsert' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'pos'=>'string', 'pivot'=>'mixed', 'value'=>'mixed'],
'RedisCluster::lLen' => ['__benevolent<RedisCluster|int|bool>', 'key'=>'string'],
'RedisCluster::lmove' => ['__benevolent<Redis|string|false>', 'src'=>'string', 'dst'=>'string', 'wherefrom'=>'string', 'whereto'=>'string'],
'RedisCluster::lmpop' => ['__benevolent<RedisCluster|array|null|false>', 'keys'=>'array', 'where'=>'string', 'count='=>'int'],
'RedisCluster::lPop' => ['__benevolent<RedisCluster|bool|string|array>', 'key'=>'string', 'count='=>'int'],
'RedisCluster::lpos' => ['__benevolent<Redis|null|bool|int|array>', 'key'=>'string', 'value'=>'mixed', 'options='=>'array|null'],
'RedisCluster::lPush' => ['__benevolent<RedisCluster|int|bool>', 'key'=>'string', 'value'=>'mixed', '...other_values='=>'mixed'],
'RedisCluster::lPushx' => ['__benevolent<RedisCluster|int|bool>', 'key'=>'string', 'value'=>'mixed'],
'RedisCluster::lRange' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'start'=>'int', 'end'=>'int'],
'RedisCluster::lRem' => ['__benevolent<RedisCluster|int|bool>', 'key'=>'string', 'value'=>'mixed', 'count='=>'int'],
'RedisCluster::lSet' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'index'=>'int', 'value'=>'mixed'],
'RedisCluster::lTrim' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'start'=>'int', 'end'=>'int'],
'RedisCluster::mget' => ['__benevolent<RedisCluster|array|false>', 'keys'=>'array'],
'RedisCluster::mset' => ['__benevolent<RedisCluster|bool>', 'key_values'=>'array'],
'RedisCluster::msetnx' => ['__benevolent<RedisCluster|array|false>', 'key_values'=>'array'],
'RedisCluster::multi' => ['__benevolent<RedisCluster|bool>', 'value='=>'int'],
'RedisCluster::object' => ['__benevolent<RedisCluster|int|string|false>', 'subcommand'=>'string', 'key'=>'string'],
'RedisCluster::persist' => ['__benevolent<RedisCluster|bool>', 'key'=>'string'],
'RedisCluster::pExpire' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'timeout'=>'int', 'mode='=>'string|null'],
'RedisCluster::pExpireAt' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'timestamp'=>'int', 'mode='=>'string|null'],
'RedisCluster::pexpiretime' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::pfAdd' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'elements'=>'array'],
'RedisCluster::pfCount' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::pfMerge' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'keys'=>'array'],
'RedisCluster::ping' => ['mixed', 'key_or_address'=>'string|array', 'message='=>'string|null'],
'RedisCluster::psetex' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'timeout'=>'int', 'value'=>'string'],
'RedisCluster::psubscribe' => ['void', 'patterns'=>'array', 'callback'=>'callable'],
'RedisCluster::pttl' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::publish' => ['__benevolent<RedisCluster|bool|int>', 'channel'=>'string', 'message'=>'string'],
'RedisCluster::pubsub' => ['mixed', 'key_or_address'=>'string|array', '...values='=>'string'],
'RedisCluster::punSubscribe' => ['__benevolent<bool|array>', 'pattern'=>'string', '...other_patterns='=>'string'],
'RedisCluster::randomKey' => ['__benevolent<RedisCluster|bool|string>', 'key_or_address'=>'string|array'],
'RedisCluster::rawCommand' => ['mixed', 'key_or_address'=>'string|array', 'command'=>'string', '...args='=>'mixed'],
'RedisCluster::rename' => ['__benevolent<RedisCluster|bool>', 'key_src'=>'string', 'key_dst'=>'string'],
'RedisCluster::renameNx' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'newkey'=>'string'],
'RedisCluster::restore' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'timeout'=>'int', 'value'=>'string', 'options='=>'array|null'],
'RedisCluster::role' => ['mixed', 'key_or_address'=>'string|array'],
'RedisCluster::rPop' => ['__benevolent<RedisCluster|bool|string|array>', 'key'=>'string', 'count='=>'int'],
'RedisCluster::rpoplpush' => ['__benevolent<RedisCluster|bool|string>', 'src'=>'string', 'dst'=>'string'],
'RedisCluster::rPush' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', '...elements='=>'mixed'],
'RedisCluster::rPushx' => ['__benevolent<RedisCluster|bool|int>', 'key'=>'string', 'value'=>'string'],
'RedisCluster::sAdd' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'value'=>'mixed', '...other_values='=>'mixed'],
'RedisCluster::sAddArray' => ['__benevolent<RedisCluster|bool|int>', 'key'=>'string', 'values'=>'array'],
'RedisCluster::save' => ['__benevolent<RedisCluster|bool>', 'key_or_address'=>'string|array'],
'RedisCluster::scan' => ['__benevolent<bool|array>', '&iterator'=>'null|int|string', 'key_or_address'=>'string|array', 'pattern='=>'string|null', 'count='=>'int'],
'RedisCluster::sCard' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::script' => ['mixed', 'key_or_address'=>'string|array', '...args='=>'mixed'],
'RedisCluster::sDiff' => ['__benevolent<RedisCluster|list<string>|false>', 'key'=>'string', '...other_keys='=>'string'],
'RedisCluster::sDiffStore' => ['__benevolent<RedisCluster|int|false>', 'dst'=>'string', 'key'=>'string', '...other_keys='=>'string'],
'RedisCluster::set' => ['__benevolent<RedisCluster|string|bool>', 'key'=>'string', 'value'=>'mixed', 'options='=>'mixed'],
'RedisCluster::setBit' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'offset'=>'int', 'onoff'=>'bool'],
'RedisCluster::setex' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'expire'=>'int', 'value'=>'mixed'],
'RedisCluster::setnx' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'value'=>'mixed'],
'RedisCluster::setoption' => ['bool', 'option'=>'int', 'value'=>'mixed'],
'RedisCluster::setRange' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'offset'=>'int', 'value'=>'string'],
'RedisCluster::sInter' => ['__benevolent<RedisCluster|list<string>|false>', 'key'=>'array|string', '...other_keys='=>'string'],
'RedisCluster::sintercard' => ['__benevolent<RedisCluster|int|false>', 'keys'=>'array', 'limit='=>'int'],
'RedisCluster::sInterStore' => ['__benevolent<RedisCluster|int|false>', 'key'=>'array|string', '...other_keys='=>'string'],
'RedisCluster::sIsMember' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'value'=>'mixed'],
'RedisCluster::slowLog' => ['mixed', 'key_or_address'=>'string|array', '...args='=>'mixed'],
'RedisCluster::sMembers' => ['__benevolent<RedisCluster|list<string>|false>', 'key'=>'string'],
'RedisCluster::smismember' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'member'=>'string', '...other_members='=>'string'],
'RedisCluster::sMove' => ['__benevolent<RedisCluster|bool>', 'src'=>'string', 'dst'=>'string', 'member'=>'string'],
'RedisCluster::sort' => ['__benevolent<RedisCluster|array|bool|int|string>', 'key'=>'string', 'options='=>'array|null'],
'RedisCluster::sort_ro' => ['__benevolent<RedisCluster|array|bool|int|string>', 'key'=>'string', 'options='=>'array|null'],
'RedisCluster::sPop' => ['__benevolent<RedisCluster|string|array|false>', 'key'=>'string', 'count='=>'int'],
'RedisCluster::sRandMember' => ['__benevolent<RedisCluster|string|array|false>', 'key'=>'string', 'count='=>'int'],
'RedisCluster::sRem' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'value'=>'mixed', '...other_values='=>'mixed'],
'RedisCluster::sScan' => ['__benevolent<array|false>', 'key'=>'string', '&iterator'=>'null|int|string', 'pattern='=>'string|null', 'count='=>'int'],
'RedisCluster::strlen' => ['__benevolent<RedisCluster|0|positive-int|false>', 'key'=>'string'],
'RedisCluster::subscribe' => ['void', 'channels'=>'array', 'cb'=>'callable'],
'RedisCluster::sUnion' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', '...other_keys='=>'string'],
'RedisCluster::sUnionStore' => ['__benevolent<RedisCluster|int|false>', 'dst'=>'string', 'key'=>'string', '...other_keys='=>'string'],
'RedisCluster::time' => ['__benevolent<RedisCluster|bool|array>', 'key_or_address'=>'string|array'],
'RedisCluster::touch' => ['__benevolent<RedisCluster|int|bool>', 'key'=>'mixed', '...other_keys='=>'mixed'],
'RedisCluster::ttl' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::type' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::unlink' => ['__benevolent<RedisCluster|int|false>', 'key'=>'array|string', '...other_keys='=>'string'],
'RedisCluster::unSubscribe' => ['__benevolent<bool|array>', 'channels'=>'array'],
'RedisCluster::unwatch' => ['bool'],
'RedisCluster::vadd' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'values'=>'array', 'element'=>'mixed', 'options='=>'array|null'],
'RedisCluster::vcard' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::vdim' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::vemb' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'member'=>'mixed', 'raw='=>'bool'],
'RedisCluster::vgetattr' => ['__benevolent<Redis|array|string|false>', 'key'=>'string', 'member'=>'mixed', 'decode='=>'bool'],
'RedisCluster::vinfo' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string'],
'RedisCluster::vismember' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', 'member'=>'mixed'],
'RedisCluster::vlinks' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'member'=>'mixed', 'withscores='=>'bool'],
'RedisCluster::vrandmember' => ['__benevolent<RedisCluster|array|string|false>', 'key'=>'string', 'count='=>'int'],
'RedisCluster::vrem' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'member'=>'mixed'],
'RedisCluster::vsetattr' => ['__benevolent<Redis|int|false>', 'key'=>'string', 'member'=>'mixed', 'attributes'=>'array|string'],
'RedisCluster::vsim' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'member'=>'mixed', 'options='=>'array|null'],
'RedisCluster::waitaof' => ['__benevolent<RedisCluster|array|false>', 'key_or_address'=>'string|array', 'numlocal'=>'int', 'numreplicas'=>'int', 'timeout'=>'int'],
'RedisCluster::watch' => ['__benevolent<RedisCluster|bool>', 'key'=>'string', '...other_keys='=>'string'],
'RedisCluster::xack' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'group'=>'string', 'ids'=>'array'],
'RedisCluster::xadd' => ['__benevolent<RedisCluster|string|false>', 'key'=>'string', 'id'=>'string', 'values'=>'array', 'maxlen='=>'int', 'approx='=>'bool'],
'RedisCluster::xautoclaim' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', 'group'=>'string', 'consumer'=>'string', 'min_idle'=>'int', 'start'=>'string', 'count='=>'int', 'justid='=>'bool'],
'RedisCluster::xclaim' => ['__benevolent<RedisCluster|string|array|false>', 'key'=>'string', 'group'=>'string', 'consumer'=>'string', 'min_iddle'=>'int', 'ids'=>'array', 'options'=>'array'],
'RedisCluster::xdel' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'ids'=>'array'],
'RedisCluster::xgroup' => ['mixed', 'operation'=>'string', 'key='=>'string|null', 'group='=>'string|null', 'id_or_consumer='=>'string|null', 'mkstream='=>'bool', 'entries_read='=>'int'],
'RedisCluster::xinfo' => ['mixed', 'operation'=>'string', 'arg1='=>'string|null', 'arg2='=>'string|null', 'count='=>'int'],
'RedisCluster::xlen' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::xpending' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'group'=>'string', 'start='=>'string|null', 'end='=>'string|null', 'count='=>'int', 'consumer='=>'string|null'],
'RedisCluster::xrange' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', 'start'=>'string', 'end'=>'string', 'count='=>'int'],
'RedisCluster::xread' => ['__benevolent<RedisCluster|bool|array>', 'streams'=>'array', 'count='=>'int', 'block='=>'int'],
'RedisCluster::xreadgroup' => ['__benevolent<RedisCluster|bool|array>', 'group'=>'string', 'consumer'=>'string', 'streams'=>'array', 'count='=>'int', 'block='=>'int'],
'RedisCluster::xrevrange' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', 'start'=>'string', 'end'=>'string', 'count='=>'int'],
'RedisCluster::xtrim' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'maxlen'=>'int', 'approx'=>'bool', 'minid='=>'bool', 'limit='=>'int'],
'RedisCluster::zAdd' => ['__benevolent<RedisCluster|int|float|false>', 'key'=>'string', 'score_or_options'=>'array|float', '...more_scores_and_mems='=>'mixed'],
'RedisCluster::zCard' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string'],
'RedisCluster::zCount' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'start'=>'string', 'end'=>'string'],
'RedisCluster::zdiff' => ['__benevolent<RedisCluster|array|false>', 'keys'=>'array', 'options='=>'array|null'],
'RedisCluster::zdiffstore' => ['__benevolent<RedisCluster|int|false>', 'dst'=>'string', 'keys'=>'array'],
'RedisCluster::zIncrBy' => ['__benevolent<RedisCluster|float|false>', 'key'=>'string', 'value'=>'float', 'member'=>'string'],
'RedisCluster::zinter' => ['__benevolent<RedisCluster|array|false>', 'keys'=>'array', 'weights='=>'array|null', 'options='=>'array|null'],
'RedisCluster::zintercard' => ['__benevolent<RedisCluster|int|false>', 'keys'=>'array', 'limit='=>'int'],
'RedisCluster::zInterStore' => ['__benevolent<RedisCluster|int|false>', 'dst'=>'string', 'keys'=>'array', 'weights='=>'array|null', 'aggregate='=>'string|null'],
'RedisCluster::zLexCount' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'min'=>'string', 'max'=>'string'],
'RedisCluster::zmpop' => ['__benevolent<RedisCluster|array|null|false>', 'keys'=>'array', 'from'=>'string', 'count='=>'int'],
'RedisCluster::zmscore' => ['__benevolent<Redis|array|false>', 'key'=>'string', 'member'=>'mixed', '...other_members='=>'mixed'],
'RedisCluster::zpopmax' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', 'value='=>'int|null'],
'RedisCluster::zpopmin' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', 'value='=>'int|null'],
'RedisCluster::zrandmember' => ['__benevolent<RedisCluster|string|array>', 'key'=>'string', 'options='=>'array|null'],
'RedisCluster::zRange' => ['__benevolent<RedisCluster|array|bool>', 'key'=>'string', 'start'=>'mixed', 'end'=>'mixed', 'options='=>'array|bool|null'],
'RedisCluster::zRangeByLex' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'min'=>'string', 'max'=>'string', 'offset='=>'int', 'count='=>'int'],
'RedisCluster::zRangeByScore' => ['__benevolent<RedisCluster|array|false>', 'key'=>'string', 'start'=>'string', 'end'=>'string', 'options='=>'array'],
'RedisCluster::zrangestore' => ['__benevolent<RedisCluster|int|false>', 'dstkey'=>'string', 'srckey'=>'string', 'start'=>'int', 'end'=>'int', 'options='=>'array|bool|null'],
'RedisCluster::zRank' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'member'=>'string'],
'RedisCluster::zRem' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'value'=>'string', '...other_values='=>'string'],
'RedisCluster::zRemRangeByLex' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'min'=>'string', 'max'=>'string'],
'RedisCluster::zRemRangeByRank' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'min'=>'string', 'max'=>'string'],
'RedisCluster::zRemRangeByScore' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'min'=>'string', 'max'=>'string'],
'RedisCluster::zRevRange' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', 'min'=>'string', 'max'=>'string', 'options='=>'array|null'],
'RedisCluster::zRevRangeByLex' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', 'min'=>'string', 'max'=>'string', 'options='=>'array|null'],
'RedisCluster::zRevRangeByScore' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', 'min'=>'string', 'max'=>'string', 'options='=>'array|null'],
'RedisCluster::zRevRank' => ['__benevolent<RedisCluster|int|false>', 'key'=>'string', 'member'=>'mixed'],
'RedisCluster::zScan' => ['__benevolent<RedisCluster|bool|array>', 'key'=>'string', '&iterator'=>'null|int|string', 'pattern='=>'string|null', 'count='=>'int'],
'RedisCluster::zScore' => ['__benevolent<RedisCluster|float|false>', 'key'=>'string', 'member'=>'mixed'],
'RedisCluster::zunion' => ['__benevolent<RedisCluster|array|false>', 'keys'=>'array', 'weights='=>'array|null', 'options='=>'array|null'],
'RedisCluster::zUnionStore' => ['__benevolent<RedisCluster|int|false>', 'dst'=>'string', 'keys'=>'array', 'weights='=>'array|null', 'aggregate='=>'string|null'],

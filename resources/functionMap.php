...
'password_hash' => ['non-empty-string|false', 'password'=>'string', 'algo'=>'string|int|null', 'options='=>'array'],
'password_make_salt' => ['bool', 'password'=>'string', 'hash'=>'string'],
'password_needs_rehash' => ['bool', 'hash'=>'string', 'algo'=>'string|int|null', 'options='=>'array'],

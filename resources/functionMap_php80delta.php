...
return [
	'new' => [
		...
		'PDO::lastInsertId' => ['string|false', 'name='=>'?string'],
		'PDO::prepare' => ['PDOStatement|false', 'query'=>'string', 'options='=>'array'],
		'PDO::quote' => ['string|false', 'string'=>'string', 'type='=>'int'],
		'PDO::setAttribute' => ['bool', 'attribute'=>'int', 'value'=>'mixed'],
		'PDOStatement::bindColumn' => ['bool', 'column'=>'string|int', '&var'=>'mixed', 'type='=>'int', 'maxLength='=>'int', 'driverOptions='=>'mixed'],
		'PDOStatement::bindParam' => ['bool', 'param'=>'string|int', '&var'=>'mixed', 'type='=>'int', 'maxLength='=>'int', 'driverOptions='=>'mixed'],
		...
		'PDOStatement::fetchAll' => ['array', 'mode='=>'int', 'fetch_argument='=>'int|string|callable', 'constructorArgs='=>'?array'],

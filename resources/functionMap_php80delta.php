...
return [
	'new' => [
		...
		'mb_ereg_replace' => ['string|false|null', 'pattern'=>'string', 'replacement'=>'string', 'string'=>'string', 'option='=>'string|null'],
		...
		'mb_strrpos' => ['0|positive-int|false', 'haystack'=>'string', 'needle'=>'string', 'offset='=>'int', 'encoding='=>'string|null'],
		...
		'strip_tags' => ['string', 'str'=>'string', 'allowable_tags='=>'string|array<int, string>|null'],

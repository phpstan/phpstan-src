...
return [
	'new' => [
		...
		'levenshtein' => ['int', 'string1'=>'string', 'string2'=>'string', 'insertion_cost='=>'int', 'replacement_cost='=>'int', 'deletion_cost='=>'int'],
		...
		'password_get_info' => ['array{algo: string|null, algoName: string, options: array<string, mixed>}', 'hash'=>'string'],

...
final class MethodThrowPointHelper
{
	...
	/**
	 * @param ExtensionsCollection<DynamicMethodThrowTypeExtension> $methodThrowTypeExtensions
	 * @param ExtensionsCollection<DynamicStaticMethodThrowTypeExtension> $staticMethodThrowTypeExtensions
	 */
	public function __construct(
		#[AutowiredExtensions(interface: DynamicMethodThrowTypeExtension::class)]
		private ExtensionsCollection $methodThrowTypeExtensions,
	...
	): ?InternalThrowPoint
	{
		if ($normalizedMethodCall instanceof MethodCall) {
			foreach ($this->methodThrowTypeExtensions->getAll() as $extension) {

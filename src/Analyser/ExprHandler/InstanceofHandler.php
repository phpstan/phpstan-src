 ...
 */
#[AutowiredService]
#[ShadowedByTurboExtension(implementation: __DIR__ . '/../../../turbo-ext/src/InstanceofHandler.cpp')]
final class InstanceofHandler implements ExprHandler
{
	...
	public function processExpr(NodeScopeResolver $nodeScopeResolver, Stmt $stmt, Expr $expr, MutatingScope $scope, ExpressionResultStorage $storage, callable $nodeCallback, ExpressionContext $context): ExpressionResult
	{
		...
		return $this->expressionResultFactory->create(
			...
			expr: $expr,
			variableFlow: VariableFlow::sequence($exprResult->getVariableFlow(), $classResult !== null ? $classResult->getVariableFlow() : null),
			hasYield: $hasYield,

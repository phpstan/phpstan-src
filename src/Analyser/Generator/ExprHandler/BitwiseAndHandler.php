...
/**
 * @implements ExprHandler<Expr\BinaryOp\BitwiseAnd>
 */
#[AutowiredService]
final class BitwiseAndHandler implements ExprHandler
{
	...
	{
		return $expr instanceof Expr\BinaryOp\BitwiseAnd;
	}
	...
	public function analyseExpr(Stmt $stmt, Expr $expr, GeneratorScope $scope, ExpressionContext $context, ?callable $alternativeNodeCallback): Generator
	{
		...
		return new ExprAnalysisResult(
			$this->initializerExprTypeResolver->getBitwiseAndTypeFromTypes($leftResult->type, $rightResult->type),
			$this->initializerExprTypeResolver->getBitwiseAndTypeFromTypes($leftResult->nativeType, $rightResult->nativeType),
			$rightResult->scope,

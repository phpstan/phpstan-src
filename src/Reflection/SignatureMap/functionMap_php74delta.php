...
return [
	'new' => [
		...
		'mb_str_split\'1' => ['array<int,string>|false', 'str'=>'string'],
		'mb_str_split\'2' => ['array<int,string>|false', 'str'=>'string', 'split_length='=>'int'],
		'mb_str_split\'3' => ['array<int,string>|false', 'str'=>'string', 'split_length='=>'int', 'encoding='=>'string'],

 ...
 * and the parity tooling. The name the differential tests declare the
 * native class under next to its twin is derived there the way the
 * extension derives it: "PHPStanTurbo\" plus the short class name.
 */

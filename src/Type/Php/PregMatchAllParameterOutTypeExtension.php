...
final class PregMatchAllParameterOutTypeExtension implements FunctionParameterOutTypeExtension
{
	...
	{
		return in_array(strtolower($functionReflection->getName()), ['preg_match_all'], true)

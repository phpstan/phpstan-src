...
class NodeScopeResolverTest extends TypeInferenceTestCase
{
	...
	private static function findTestFiles(): iterable
	{
		...
		if (PHP_VERSION_ID >= 80100) {
			yield __DIR__ . '/../Rules/DeadCode/data/bug-14582.php';
		}
		...
		yield __DIR__ . '/../Rules/Variables/data/bug-9392.php';
		...
		yield __DIR__ . '/../Rules/Methods/data/bug-14893.php';
		yield __DIR__ . '/../Rules/Methods/data/unconstrained-query-result.php';

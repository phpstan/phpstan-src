...
$list = [];
foreach (CountryAlpha3::cases() as $value) {
	// part A
	$value->getNameInLanguage(LanguageAlpha2::English);

	// part B, all right
	// $value->toCountryAlpha2()->getNameInLanguage(LanguageAlpha2::English);
}
...
enum CountryAlpha3: string
{
	...
	public function toCountryAlpha2(): mixed
	{
		return BackedEnum::fromName('x', $this->name);
	}
}
...
class BackedEnum {
	static public function fromName(string $s, string $t):mixed {
		return null;
	}
}

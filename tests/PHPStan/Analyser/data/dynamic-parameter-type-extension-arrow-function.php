...
namespace DynamicParameterTypeExtensionArrowFunction;
...
class FunctionDynamicParameterTypeExtension implements \PHPStan\Type\FunctionDynamicParameterTypeExtension
{
	...
	{
		return $functionReflection->getName() === 'DynamicParameterTypeExtensionArrowFunction\functionWithCallable';
	}
...
function test(Foo $foo): void
{
	...
	(new Foo)->methodWithCallable(2, fn ($arg) => assertType('string', $arg->getValue()));

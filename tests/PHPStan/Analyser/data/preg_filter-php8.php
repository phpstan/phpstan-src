...
class Foo {
	...
	function doFoo2() {
		$subject = 123;
		assertType('array<int|string, string>|string|null', preg_filter('/\d/', '$0', $subject));
	...
	public function dooFoo3(string $pattern, string $replace) {
		assertType('array<int|string, string>|string|null', preg_filter($pattern, $replace));
		assertType('array<int|string, string>|string|null', preg_filter($pattern));
		assertType('array<int|string, string>|string|null', preg_filter());
	}

...
class StrSplit {
	public function legacyTest() {
		...
		assertType('list<string>', $strSplitConstantStringWithoutDefinedParameters);
		...
		assertType('list<string>', $strSplitStringWithoutDefinedSplitLength);
		...
		assertType('list<string>', $strSplitConstantStringWithInvalidSplitLengthType);

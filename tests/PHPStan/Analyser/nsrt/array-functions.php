...
assertType('array{foo: stdClass, ...<string, int>}', array_merge($generalStringKeys, $stringOrIntegerKeys));
assertType('array{foo: int|stdClass, ...<string, int>}', array_merge($stringOrIntegerKeys, $generalStringKeys));

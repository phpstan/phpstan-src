...
assertType('list<(int|string)>', array_keys($generalStringKeys));
...
assertType('(int|string|false)', array_search(9, $generalStringKeys, true));
assertType('(int|string|false)', array_search(9, $generalStringKeys, false));
assertType('(int|string|false)', array_search(9, $generalStringKeys));

...
assertType('non-empty-array<1|string, int|stdClass>&hasOffsetValue(\'foo\', stdClass)', array_merge($generalStringKeys, $stringOrIntegerKeys));
assertType('non-empty-array<1|string, int|stdClass>&hasOffset(\'foo\')', array_merge($stringOrIntegerKeys, $generalStringKeys));

...
class Foo
{
	...
	public function mapMerge() : void
	{
		...
		assertType('Ds\Map<1|string, ExtDs\A|ExtDs\B>', $a->merge(['a' => new B()]));
	}
	...
	public function mapUnion() : void
	{
		...
		assertType('Ds\Map<1|string, ExtDs\A|ExtDs\B>', $a->union($b));
	}
	...
	public function mapXor() : void
	{
		...
		assertType('Ds\Map<1|string, ExtDs\A|ExtDs\B>', $a->xor($b));
	}

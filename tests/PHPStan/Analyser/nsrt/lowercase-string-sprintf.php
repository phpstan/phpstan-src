...
class Foo
{
	...
	public function doSprintf(
		...
		assertType('non-decimal-int-string&non-falsy-string', sprintf($format, $lowercase));
		assertType('lowercase-string&non-decimal-int-string&non-falsy-string', sprintf($formatLower, $lowercase));
		...
		assertType('non-decimal-int-string&non-falsy-string', sprintf($format, $nonEmptyLowercase));
		assertType('lowercase-string&non-decimal-int-string&non-falsy-string', sprintf($formatLower, $nonEmptyLowercase));
		...
		assertType('non-decimal-int-string&non-falsy-string', sprintf($format, $nonFalsyLowercase));
		assertType('lowercase-string&non-decimal-int-string&non-falsy-string', sprintf($formatLower, $nonFalsyLowercase));
	...
	public function doVSprintf(
		...
		assertType('non-decimal-int-string&non-falsy-string', vsprintf($format, [$constant]));
		assertType('non-decimal-int-string&non-falsy-string', vsprintf($formatLower, [$constant]));
		...
		assertType('non-decimal-int-string&non-falsy-string', vsprintf($format, [$constantLower]));
		assertType('lowercase-string&non-decimal-int-string&non-falsy-string', vsprintf($formatLower, [$constantLower]));
		...
		assertType('non-decimal-int-string&non-falsy-string', vsprintf($format, [$lowercase]));
		assertType('lowercase-string&non-decimal-int-string&non-falsy-string', vsprintf($formatLower, [$lowercase]));
		...
		assertType('non-decimal-int-string&non-falsy-string', vsprintf($format, [$nonEmptyLowercase]));
		assertType('lowercase-string&non-decimal-int-string&non-falsy-string', vsprintf($formatLower, [$nonEmptyLowercase]));
		...
		assertType('non-decimal-int-string&non-falsy-string', vsprintf($format, [$nonFalsyLowercase]));
		assertType('lowercase-string&non-decimal-int-string&non-falsy-string', vsprintf($formatLower, [$nonFalsyLowercase]));

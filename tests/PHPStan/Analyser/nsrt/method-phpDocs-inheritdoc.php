...
class FooInheritDocChild extends Foo
{
	...
	)
	{
		...
		foreach ($moreSpecifiedObject->doFluentUnionIterable() as $fluentUnionIterableBaz) {
			...
			assertType('static(MethodPhpDocsNamespace\FooInheritDocChild)', $staticType);
			assertType('MethodPhpDocsNamespace\Foo', $this->doFoo());
			assertType('MethodPhpDocsNamespace\Bar', static::doSomethingStatic());
			assertType('static(MethodPhpDocsNamespace\FooInheritDocChild)', parent::doLorem());
			assertType('static(MethodPhpDocsNamespace\FooInheritDocChild)', $this->doLorem());
			assertType('MethodPhpDocsNamespace\Foo', $differentInstance->doLorem());
			assertType('static(MethodPhpDocsNamespace\FooInheritDocChild)', parent::doIpsum());
			assertType('MethodPhpDocsNamespace\Foo', $differentInstance->doIpsum());
			assertType('static(MethodPhpDocsNamespace\FooInheritDocChild)', $this->doIpsum());
			...
			assertType('$this(MethodPhpDocsNamespace\FooInheritDocChild)', parent::doThis());
			assertType('$this(MethodPhpDocsNamespace\FooInheritDocChild)|null', parent::doThisNullable());
			assertType('$this(MethodPhpDocsNamespace\FooInheritDocChild)|MethodPhpDocsNamespace\Bar|null', parent::doThisUnion());
			...
			assertType('MethodPhpDocsNamespace\FooInheritDocChild', $inlineSelf);

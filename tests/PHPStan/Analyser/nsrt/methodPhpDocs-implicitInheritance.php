...
class FooPhpDocsImplicitInheritanceChild extends Foo
{
	...
	)
	{
		...
		foreach ($moreSpecifiedObject->doFluentUnionIterable() as $fluentUnionIterableBaz) {
			...
			assertType('static(MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild)', $staticType);
			assertType('MethodPhpDocsNamespace\Foo', $this->doFoo());
			assertType('MethodPhpDocsNamespace\Bar', static::doSomethingStatic());
			assertType('static(MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild)', parent::doLorem());
			assertType('static(MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild)', $this->doLorem());
			assertType('MethodPhpDocsNamespace\Foo', $differentInstance->doLorem());
			assertType('static(MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild)', parent::doIpsum());
			assertType('MethodPhpDocsNamespace\Foo', $differentInstance->doIpsum());
			assertType('static(MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild)', $this->doIpsum());
			...
			assertType('$this(MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild)', parent::doThis());
			assertType('$this(MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild)|null', parent::doThisNullable());
			assertType('$this(MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild)|MethodPhpDocsNamespace\Bar|null', parent::doThisUnion());
			...
			assertType('MethodPhpDocsNamespace\FooPhpDocsImplicitInheritanceChild', $inlineSelf);

...
function notConstant(float $floatUnion, float $precisionUnion, float $modeUnion, $IntOrNumStr, $floatOrNumStr)
{
	...
	assertType('1.0|3.0', round($IntOrNumStr, mode: PHP_ROUND_HALF_UP));
	assertType('1.0|2.0', round($IntOrNumStr, mode: PHP_ROUND_HALF_DOWN));

	assertType('1.0|2.0', round($floatOrNumStr));
	assertType('1.0|2.0', round($floatOrNumStr, mode: PHP_ROUND_HALF_UP));
	assertType('1.0|2.0', round($floatOrNumStr, mode: PHP_ROUND_HALF_DOWN));
}

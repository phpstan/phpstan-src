...
class NonexistentOffsetInArrayDimFetchRuleTest extends RuleTestCase
{
	...
	public function testBug7893(): void
	{
		$this->analyse([__DIR__ . '/data/bug-7893.php'], []);
	}

	public function testBug2294(): void
	{
		$this->analyse([__DIR__ . '/data/bug-2294.php'], []);
	}
	...
	public function testBug13699(): void
	{
		$this->analyse([__DIR__ . '/data/bug-13699.php'], []);
	}

	public function testBug14448(): void
	{
		$this->reportPossiblyNonexistentGeneralArrayOffset = true;
		$this->analyse([__DIR__ . '/data/bug-14448.php'], []);
	}

	public function testBug14999(): void
	{
		$this->checkExplicitMixed = true;
		$this->checkImplicitMixed = true;
		$this->analyse([__DIR__ . '/data/bug-14999.php'], []);
	}
	...
	{
		$this->analyse([__DIR__ . '/data/bug-14054.php'], []);
	}

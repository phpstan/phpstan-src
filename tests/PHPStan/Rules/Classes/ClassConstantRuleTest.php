...
class ClassConstantRuleTest extends RuleTestCase
{
	...
	protected function getRule(): Rule
	{
		...
		return new ClassConstantRule($broker, new RuleLevelHelper($broker, true, false, true, false, false, true), new ClassCaseSensitivityCheck($broker, true), new PhpVersion($this->phpVersion));
	}

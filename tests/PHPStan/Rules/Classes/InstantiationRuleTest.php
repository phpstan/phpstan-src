...
class InstantiationRuleTest extends \PHPStan\Testing\RuleTestCase
{
	...
	protected function getRule(): \PHPStan\Rules\Rule
	{
		...
		return new InstantiationRule(
			$broker,
			new FunctionCallParametersCheck(new RuleLevelHelper($broker, true, false, true, false), new NullsafeCheck(), new PhpVersion(80000), new UnresolvableTypeHelper(), true, true, true, true, true),

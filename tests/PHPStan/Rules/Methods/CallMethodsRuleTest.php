...
class CallMethodsRuleTest extends RuleTestCase
{
	...
	public function testIterables(bool $checkNullables): void
	{
		...
		$this->analyse([__DIR__ . '/data/call-methods-iterable.php'], [
			[
				'Parameter #1 $ids of method CallMethodsIterables\Uuid::bar() expects array<CallMethodsIterables\Uuid>, array<int, null> given.',
				14,
			],
			[
			...
			[
				'Parameter #3 $iterableWithConcreteTypehint of method CallMethodsIterables\Foo::doFoo() expects array<CallMethodsIterables\Bar>, int given.',
				62,
			],
			[

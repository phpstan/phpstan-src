...
class CallMethodsRuleTest extends RuleTestCase
{
	...
	public function testCallMethods(): void
	{
		...
		$this->analyse([ __DIR__ . '/data/call-methods.php'], [
			...
			[
				...
				1638,
				"Sealed array shape does not accept array with extra key 'undocumented'.",
			],
			[
	...
	#[RequiresPhp('>= 8.0.0')]
	public function testBug14720(): void
	{
		$this->checkThisOnly = false;
		$this->checkNullables = true;
		$this->checkUnionTypes = true;
	...
	public function testBug4865(): void
	{
		$this->checkThisOnly = false;
		$this->checkNullables = true;
		$this->checkUnionTypes = true;
	...
	public function testBug5258(): void
	{
		...
		$this->analyse([__DIR__ . '/data/bug-5258.php'], [
			[
				...
				12,
				"Sealed array shape does not accept array with extra key 'some_key'.",
			],
			[
...
• object might not have property $bar.',
	...
	#[RequiresPhp('>= 8.0.0')]
	public function testClosureBindToParamClosureThisNamedArgs(): void
	{
		$this->checkThisOnly = false;
		$this->checkNullables = true;
		$this->checkUnionTypes = true;
		$this->checkExplicitMixed = true;
		$this->analyse([__DIR__ . '/data/closure-bind-to-param-closure-this-named-args.php'], [
			[
				'Parameter $newThis of method Closure::bindTo() expects stdClass, ClosureBindToParamClosureThisNamedArgs\Foo given.',
				14,
			],
			[
				'Parameter $newThis of method Closure::bindTo() expects stdClass, ClosureBindToParamClosureThisNamedArgs\Foo given.',
	...
	public function testDynamicCall(): void
	{
		...
		$this->analyse([__DIR__ . '/data/dynamic-call.php'], [
			...
			[
				'Method name for $this(MethodsDynamicCall\Foo) must be a string, but object was given.',
				25,
			],
			[
	...
	public function testDynamicMethodName(): void
	{
		$this->checkThisOnly = false;
		$this->checkNullables = true;
		$this->checkUnionTypes = true;
		$this->checkExplicitMixed = true;
		$this->analyse([__DIR__ . '/data/dynamic-method-name.php'], [
			[
				'Method name for $this(DynamicMethodName\Foo) must be a string, but $this(DynamicMethodName\Foo) was given.',
				16,
			],
			[
				'Method name for $this(DynamicMethodName\Foo) must be a string, but object was given.',
				17,
			],
			[
				'Method name for $this(DynamicMethodName\Foo) must be a string, but Stringable was given.',
				18,
			],
			[
				'Method name for $this(DynamicMethodName\Foo) must be a string, but int was given.',
				19,
			],
		]);
	}
	...
	#[RequiresPhp('>= 8.0.0')]
	public function testBug14808(): void
	{
		$this->checkThisOnly = false;
		$this->checkNullables = true;
		$this->checkUnionTypes = true;

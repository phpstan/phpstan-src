...
namespace Bug8146bError;
// same as tests/PHPStan/Analyser/data/bug-8146b.php but with a type error in the first array item
class X{}
...
class LocationFixtures
{
	...
	public function getData(): array
	{
		return [
			'Bács-Kiskun' => [
				'Ágasegyháza' => [
					'constituencies' => ['Bács-Kiskun 4.', true, false, new X(), null], // expected type errors

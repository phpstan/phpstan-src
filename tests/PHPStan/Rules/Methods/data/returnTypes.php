...
{
	/** @return list */
	public function withoutReturnHint()
	{
		$a = [];
		$a[] = '1';
		$a[] = true;
	...
	/** @return list */
	public function withGoodReturnHint(): array
	{
		$a = [];
		$a[] = '1';
		$a[] = true;
	...
	/** @return list */
	public function withWrongReturnHint(): int
	{
		$a = [];
		$a[] = '1';
		$a[] = true;
	...
	public function withGenerics(): array
	{
		$a = [];
		$a[] = new returnList();
		return $a;
	...
	/** @return list<mixed> */
	public function withMixed(): array
	{
		$a = [];
		$a[] = '1';
		$a[] = true;
	...
	/** @return list<scalar> */
	public function withScalarGood(): array
	{
		$a = [];
		$a[] = '1';
		$a[] = true;
	...
	/** @return list<scalar> */
	public function withScalarWrong(): array
	{
		$a = [];
		$a[] = '1';
		$a[] = true;

...
class AccessStaticPropertiesInAssignRuleTest extends RuleTestCase
{
	...
	protected function getRule(): Rule
	{
		...
		return new AccessStaticPropertiesInAssignRule(
			new AccessStaticPropertiesRule($reflectionProvider, new RuleLevelHelper($reflectionProvider, true, false, true, false, false, false), new ClassCaseSensitivityCheck($reflectionProvider, true)),
		);
	}

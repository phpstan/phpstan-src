...
class WritingToReadOnlyPropertiesRuleTest extends RuleTestCase
{
	...
	{
		return new WritingToReadOnlyPropertiesRule(new RuleLevelHelper($this->createReflectionProvider(), true, false, true, false, false, true), new PropertyDescriptor(), new PropertyReflectionFinder(), $this->checkThisOnly);
	}

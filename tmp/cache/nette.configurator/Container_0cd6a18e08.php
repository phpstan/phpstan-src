...
class Container_0cd6a18e08 extends Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0454(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_0cd6a18e08 $container)
			{
	...
	public function createServiceContainer(): Container_0cd6a18e08
	{
		return $this;
	}

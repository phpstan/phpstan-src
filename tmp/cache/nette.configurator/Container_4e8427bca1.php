...
class Container_4e8427bca1 extends Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0454(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_4e8427bca1 $container)
			{
	...
	public function createServiceContainer(): Container_4e8427bca1
	{
		return $this;
	}

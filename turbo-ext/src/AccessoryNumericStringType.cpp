...
void pt_register_accessory_numeric_string_type()
{
	...
	cls.op(PT_OP_HAS_OFFSET_VALUE_TYPE, PT_OP_LAMBDA { return pt_op_trinary(AccessoryNumericStringType::hasOffsetValueType(argv)); });
	...
	cls.op<PT_OP_GET_OFFSET_VALUE_TYPE, &AccessoryNumericStringType::getOffsetValueType>();

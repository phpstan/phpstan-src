 ...
 * the callee */
pt_method_site pt_ah_parameter_get_name_site;
pt_method_site pt_ah_parameter_passed_by_reference_site;
pt_method_site pt_ah_parameter_get_type_site;
pt_method_site pt_ah_parameter_get_native_type_site;

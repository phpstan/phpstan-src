 ...
 * src/Analyser/ExprHandler/Virtual/AlwaysRememberedExprHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_ALWAYS_REMEMBERED_EXPR_HANDLER_H
#define PHPSTANTURBO_GENERATED_ALWAYS_REMEMBERED_EXPR_HANDLER_H

#include "../reg.h"

namespace ptdecl::AlwaysRememberedExprHandler {

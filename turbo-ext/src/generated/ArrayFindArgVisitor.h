 ...
 * src/Parser/ArrayFindArgVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_ARRAY_FIND_ARG_VISITOR_H
#define PHPSTANTURBO_GENERATED_ARRAY_FIND_ARG_VISITOR_H

#include "../reg.h"

namespace ptdecl::ArrayFindArgVisitor {

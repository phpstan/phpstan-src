 ...
 * src/Parser/ArrowFunctionArgVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_ARROW_FUNCTION_ARG_VISITOR_H
#define PHPSTANTURBO_GENERATED_ARROW_FUNCTION_ARG_VISITOR_H

#include "../reg.h"

namespace ptdecl::ArrowFunctionArgVisitor {

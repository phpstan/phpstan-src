 ...
 * src/Parser/ClosureArgVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_CLOSURE_ARG_VISITOR_H
#define PHPSTANTURBO_GENERATED_CLOSURE_ARG_VISITOR_H

#include "../reg.h"

namespace ptdecl::ClosureArgVisitor {

 ...
 * src/Parser/ClosureBindToVarVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_CLOSURE_BIND_TO_VAR_VISITOR_H
#define PHPSTANTURBO_GENERATED_CLOSURE_BIND_TO_VAR_VISITOR_H

#include "../reg.h"

namespace ptdecl::ClosureBindToVarVisitor {

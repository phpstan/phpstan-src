...
inline constexpr char strings[] =
	...
	"processExpr\0" /* 653 */
	"PhpParser\\Node\\Expr\\Closure\0" /* 665 */
	"PHPStan\\Analyser\\VariableFlow\0" /* 693 */
	"getVariableFlow"; /* 723 */
inline constexpr reg::PackedArg args[] = {
	...
	reg::packed(389, MAY_BE_NULL, 693), /* getVariableFlow return */
};
...
inline constexpr sigtab::Sig getVariableFlow = { { 723 /* getVariableFlow */, 1, 15, 1, 16, ZEND_ACC_PUBLIC | ZEND_ACC_STATIC } };
} // namespace sig

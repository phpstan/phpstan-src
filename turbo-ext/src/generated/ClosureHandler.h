...
inline constexpr reg::Arg getVariableFlow_args[] = { reg::typed("expr", 0, "PhpParser\\Node\\Expr\\Closure") };
inline constexpr reg::Arg getVariableFlow_return = reg::typed("", MAY_BE_NULL, "PHPStan\\Analyser\\VariableFlow");
inline constexpr reg::Sig getVariableFlow = { "getVariableFlow", ZEND_ACC_PUBLIC | ZEND_ACC_STATIC, 1, getVariableFlow_args, 1, &getVariableFlow_return };
} // namespace sig

 ...
 * src/Analyser/StmtHandler/ConstHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_CONST_HANDLER_H
#define PHPSTANTURBO_GENERATED_CONST_HANDLER_H

#include "../reg.h"

namespace ptdecl::ConstHandler {

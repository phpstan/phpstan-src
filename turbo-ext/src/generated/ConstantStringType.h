...
inline constexpr reg::Arg eraseTypeArguments_args[] = { reg::typed("type", 0, "PHPStan\\Type\\Type") };
inline constexpr reg::Arg eraseTypeArguments_return = reg::typed("", 0, "PHPStan\\Type\\Type");
inline constexpr reg::Sig eraseTypeArguments = { "eraseTypeArguments", ZEND_ACC_PRIVATE | ZEND_ACC_STATIC, 1, eraseTypeArguments_args, 1, &eraseTypeArguments_return };

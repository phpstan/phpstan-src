 ...
 * src/Parser/CurlSetOptArgVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_CURL_SET_OPT_ARG_VISITOR_H
#define PHPSTANTURBO_GENERATED_CURL_SET_OPT_ARG_VISITOR_H

#include "../reg.h"

namespace ptdecl::CurlSetOptArgVisitor {

 ...
 * src/Parser/CurlSetOptArrayArgVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_CURL_SET_OPT_ARRAY_ARG_VISITOR_H
#define PHPSTANTURBO_GENERATED_CURL_SET_OPT_ARRAY_ARG_VISITOR_H

#include "../reg.h"

namespace ptdecl::CurlSetOptArrayArgVisitor {

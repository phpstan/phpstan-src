 ...
 * src/Analyser/StmtHandler/DeclareHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_DECLARE_HANDLER_H
#define PHPSTANTURBO_GENERATED_DECLARE_HANDLER_H

#include "../reg.h"

namespace ptdecl::DeclareHandler {

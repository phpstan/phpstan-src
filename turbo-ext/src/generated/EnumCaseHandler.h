 ...
 * src/Analyser/StmtHandler/EnumCaseHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_ENUM_CASE_HANDLER_H
#define PHPSTANTURBO_GENERATED_ENUM_CASE_HANDLER_H

#include "../reg.h"

namespace ptdecl::EnumCaseHandler {

 ...
 * src/Analyser/ExprHandler/EvalHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_EVAL_HANDLER_H
#define PHPSTANTURBO_GENERATED_EVAL_HANDLER_H

#include "../reg.h"

namespace ptdecl::EvalHandler {

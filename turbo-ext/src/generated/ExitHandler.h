 ...
 * src/Analyser/ExprHandler/ExitHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_EXIT_HANDLER_H
#define PHPSTANTURBO_GENERATED_EXIT_HANDLER_H

#include "../reg.h"

namespace ptdecl::ExitHandler {

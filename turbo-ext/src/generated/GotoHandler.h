 ...
 * src/Analyser/StmtHandler/GotoHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_GOTO_HANDLER_H
#define PHPSTANTURBO_GENERATED_GOTO_HANDLER_H

#include "../reg.h"

namespace ptdecl::GotoHandler {

 ...
 * src/Analyser/StmtHandler/GroupUseHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_GROUP_USE_HANDLER_H
#define PHPSTANTURBO_GENERATED_GROUP_USE_HANDLER_H

#include "../reg.h"

namespace ptdecl::GroupUseHandler {

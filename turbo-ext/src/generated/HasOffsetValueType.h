...
namespace sig {
inline constexpr reg::Arg __construct_args[] = { reg::typed("offsetType", 0, "PHPStan\\Type\\Constant\\ConstantStringType|PHPStan\\Type\\Constant\\ConstantIntegerType"), reg::typed("valueType", 0, "PHPStan\\Type\\Type") };

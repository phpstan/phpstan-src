 ...
 * src/Analyser/StmtHandler/IfHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_IF_HANDLER_H
#define PHPSTANTURBO_GENERATED_IF_HANDLER_H

#include "../reg.h"

namespace ptdecl::IfHandler {
...
namespace sig {
inline constexpr reg::Arg __construct_args[] = { reg::typed("treatPhpDocTypesAsCertain", MAY_BE_BOOL) };

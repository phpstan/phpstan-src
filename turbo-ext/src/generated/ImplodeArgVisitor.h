 ...
 * src/Parser/ImplodeArgVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_IMPLODE_ARG_VISITOR_H
#define PHPSTANTURBO_GENERATED_IMPLODE_ARG_VISITOR_H

#include "../reg.h"

namespace ptdecl::ImplodeArgVisitor {

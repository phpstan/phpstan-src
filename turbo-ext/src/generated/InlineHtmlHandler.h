 ...
 * src/Analyser/StmtHandler/InlineHtmlHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_INLINE_HTML_HANDLER_H
#define PHPSTANTURBO_GENERATED_INLINE_HTML_HANDLER_H

#include "../reg.h"

namespace ptdecl::InlineHtmlHandler {

 ...
 * src/Analyser/ExprHandler/InstanceofHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_INSTANCEOF_HANDLER_H
#define PHPSTANTURBO_GENERATED_INSTANCEOF_HANDLER_H

#include "../reg.h"

namespace ptdecl::InstanceofHandler {

 ...
 * src/Analyser/ExprHandler/Virtual/IssetExprHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_ISSET_EXPR_HANDLER_H
#define PHPSTANTURBO_GENERATED_ISSET_EXPR_HANDLER_H

#include "../reg.h"

namespace ptdecl::IssetExprHandler {

 ...
 * src/Analyser/StmtHandler/LabelHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_LABEL_HANDLER_H
#define PHPSTANTURBO_GENERATED_LABEL_HANDLER_H

#include "../reg.h"

namespace ptdecl::LabelHandler {

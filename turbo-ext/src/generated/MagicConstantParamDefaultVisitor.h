 ...
 * src/Parser/MagicConstantParamDefaultVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_MAGIC_CONSTANT_PARAM_DEFAULT_VISITOR_H
#define PHPSTANTURBO_GENERATED_MAGIC_CONSTANT_PARAM_DEFAULT_VISITOR_H

#include "../reg.h"

namespace ptdecl::MagicConstantParamDefaultVisitor {

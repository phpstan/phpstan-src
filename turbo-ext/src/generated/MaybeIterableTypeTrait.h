 ...
 * src/Type/Traits/MaybeIterableTypeTrait.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_MAYBE_ITERABLE_TYPE_TRAIT_H
#define PHPSTANTURBO_GENERATED_MAYBE_ITERABLE_TYPE_TRAIT_H

#include "../reg.h"

namespace ptdecl::MaybeIterableTypeTrait {

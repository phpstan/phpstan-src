 ...
 * src/Analyser/StmtHandler/NamespaceHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_NAMESPACE_HANDLER_H
#define PHPSTANTURBO_GENERATED_NAMESPACE_HANDLER_H

#include "../reg.h"

namespace ptdecl::NamespaceHandler {

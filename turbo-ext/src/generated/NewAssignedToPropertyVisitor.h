 ...
 * src/Parser/NewAssignedToPropertyVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_NEW_ASSIGNED_TO_PROPERTY_VISITOR_H
#define PHPSTANTURBO_GENERATED_NEW_ASSIGNED_TO_PROPERTY_VISITOR_H

#include "../reg.h"

namespace ptdecl::NewAssignedToPropertyVisitor {

 ...
 * src/Type/NewObjectType.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_NEW_OBJECT_TYPE_H
#define PHPSTANTURBO_GENERATED_NEW_OBJECT_TYPE_H

#include "../reg.h"

namespace ptdecl::NewObjectType {

 ...
 * src/Analyser/StmtHandler/NopHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_NOP_HANDLER_H
#define PHPSTANTURBO_GENERATED_NOP_HANDLER_H

#include "../reg.h"

namespace ptdecl::NopHandler {

 ...
 * src/Analyser/ExprHandler/PipeHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_PIPE_HANDLER_H
#define PHPSTANTURBO_GENERATED_PIPE_HANDLER_H

#include "../reg.h"

namespace ptdecl::PipeHandler {

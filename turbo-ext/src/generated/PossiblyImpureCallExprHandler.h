 ...
 * src/Analyser/ExprHandler/Virtual/PossiblyImpureCallExprHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_POSSIBLY_IMPURE_CALL_EXPR_HANDLER_H
#define PHPSTANTURBO_GENERATED_POSSIBLY_IMPURE_CALL_EXPR_HANDLER_H

#include "../reg.h"

namespace ptdecl::PossiblyImpureCallExprHandler {

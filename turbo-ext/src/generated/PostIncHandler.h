 ...
 * src/Analyser/ExprHandler/PostIncHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_POST_INC_HANDLER_H
#define PHPSTANTURBO_GENERATED_POST_INC_HANDLER_H

#include "../reg.h"

namespace ptdecl::PostIncHandler {

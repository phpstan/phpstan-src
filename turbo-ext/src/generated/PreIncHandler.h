 ...
 * src/Analyser/ExprHandler/PreIncHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_PRE_INC_HANDLER_H
#define PHPSTANTURBO_GENERATED_PRE_INC_HANDLER_H

#include "../reg.h"

namespace ptdecl::PreIncHandler {

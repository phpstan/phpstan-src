 ...
 * src/Analyser/StmtHandler/ReturnHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_RETURN_HANDLER_H
#define PHPSTANTURBO_GENERATED_RETURN_HANDLER_H

#include "../reg.h"

namespace ptdecl::ReturnHandler {

 ...
 * src/Analyser/ExprHandler/Virtual/StaticMethodCallableNodeHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_STATIC_METHOD_CALLABLE_NODE_HANDLER_H
#define PHPSTANTURBO_GENERATED_STATIC_METHOD_CALLABLE_NODE_HANDLER_H

#include "../reg.h"

namespace ptdecl::StaticMethodCallableNodeHandler {

 ...
 * src/Type/Generic/TemplateBooleanType.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_TEMPLATE_BOOLEAN_TYPE_H
#define PHPSTANTURBO_GENERATED_TEMPLATE_BOOLEAN_TYPE_H

#include "../reg.h"

namespace ptdecl::TemplateBooleanType {

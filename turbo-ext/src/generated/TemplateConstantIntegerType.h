 ...
 * src/Type/Generic/TemplateConstantIntegerType.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_TEMPLATE_CONSTANT_INTEGER_TYPE_H
#define PHPSTANTURBO_GENERATED_TEMPLATE_CONSTANT_INTEGER_TYPE_H

#include "../reg.h"

namespace ptdecl::TemplateConstantIntegerType {
...
{
	cls.final();
	cls.parent("PHPStan\\Type\\Constant\\ConstantIntegerType");
...
inline constexpr char strings[] =
	...
	"name\0" /* 171 */
	"bound\0" /* 176 */
	"PHPStan\\Type\\Constant\\ConstantIntegerType\0" /* 182 */
	"default\0" /* 224 */
	"PHPStan\\Type\\Type\0" /* 232 */
	"__construct"; /* 250 */
inline constexpr reg::PackedArg args[] = {
	...
	reg::packed(224, MAY_BE_NULL, 232), /* __construct $default */
};
...
namespace sig {
inline constexpr sigtab::Sig __construct = { { 250 /* __construct */, 6, 0, 6, reg::NoArg, ZEND_ACC_PUBLIC } };
} // namespace sig

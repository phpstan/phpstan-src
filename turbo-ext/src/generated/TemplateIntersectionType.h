 ...
 * src/Type/Generic/TemplateIntersectionType.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_TEMPLATE_INTERSECTION_TYPE_H
#define PHPSTANTURBO_GENERATED_TEMPLATE_INTERSECTION_TYPE_H

#include "../reg.h"

namespace ptdecl::TemplateIntersectionType {

/* the OBJ_PROP_NUM slots of the instance properties the class declares (the inherited ones come first) */
namespace slot {
inline constexpr uint32_t name = 17;
inline constexpr uint32_t scope = 18;
inline constexpr uint32_t strategy = 19;
inline constexpr uint32_t variance = 20;
inline constexpr uint32_t bound = 21;
inline constexpr uint32_t default_ = 22;
} // namespace slot

inline void declareClass(reg::Class &cls)
{
	cls.final();
	cls.parent("PHPStan\\Type\\IntersectionType");
...
inline constexpr char strings[] =
	...
	"name\0" /* 171 */
	"bound\0" /* 176 */
	"PHPStan\\Type\\IntersectionType\0" /* 182 */
	"default\0" /* 212 */
	"PHPStan\\Type\\Type\0" /* 220 */
	"__construct"; /* 238 */
inline constexpr reg::PackedArg args[] = {
	...
	reg::packed(212, MAY_BE_NULL, 220), /* __construct $default */
};
...
namespace sig {
inline constexpr sigtab::Sig __construct = { { 238 /* __construct */, 6, 0, 6, reg::NoArg, ZEND_ACC_PUBLIC } };
} // namespace sig

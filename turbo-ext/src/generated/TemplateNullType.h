 ...
 * src/Type/Generic/TemplateNullType.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_TEMPLATE_NULL_TYPE_H
#define PHPSTANTURBO_GENERATED_TEMPLATE_NULL_TYPE_H

#include "../reg.h"

namespace ptdecl::TemplateNullType {
...
{
	cls.final();
	cls.parent("PHPStan\\Type\\NullType");
...
inline constexpr char strings[] =
	...
	"name\0" /* 171 */
	"bound\0" /* 176 */
	"PHPStan\\Type\\NullType\0" /* 182 */
	"default\0" /* 204 */
	"PHPStan\\Type\\Type\0" /* 212 */
	"__construct"; /* 230 */
inline constexpr reg::PackedArg args[] = {
	...
	reg::packed(204, MAY_BE_NULL, 212), /* __construct $default */
};
...
namespace sig {
inline constexpr sigtab::Sig __construct = { { 230 /* __construct */, 6, 0, 6, reg::NoArg, ZEND_ACC_PUBLIC } };
} // namespace sig

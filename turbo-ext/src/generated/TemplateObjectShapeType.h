 ...
 * src/Type/Generic/TemplateObjectShapeType.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_TEMPLATE_OBJECT_SHAPE_TYPE_H
#define PHPSTANTURBO_GENERATED_TEMPLATE_OBJECT_SHAPE_TYPE_H

#include "../reg.h"

namespace ptdecl::TemplateObjectShapeType {
...
{
	cls.final();
	cls.parent("PHPStan\\Type\\ObjectShapeType");
...
inline constexpr char strings[] =
	...
	"name\0" /* 171 */
	"bound\0" /* 176 */
	"PHPStan\\Type\\ObjectShapeType\0" /* 182 */
	"default\0" /* 211 */

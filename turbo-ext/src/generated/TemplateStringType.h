 ...
 * src/Type/Generic/TemplateStringType.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_TEMPLATE_STRING_TYPE_H
#define PHPSTANTURBO_GENERATED_TEMPLATE_STRING_TYPE_H

#include "../reg.h"

namespace ptdecl::TemplateStringType {

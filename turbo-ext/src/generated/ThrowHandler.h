 ...
 * src/Analyser/ExprHandler/ThrowHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_THROW_HANDLER_H
#define PHPSTANTURBO_GENERATED_THROW_HANDLER_H

#include "../reg.h"

namespace ptdecl::ThrowHandler {

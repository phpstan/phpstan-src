 ...
 * src/Analyser/StmtHandler/TryCatchHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_TRY_CATCH_HANDLER_H
#define PHPSTANTURBO_GENERATED_TRY_CATCH_HANDLER_H

#include "../reg.h"

namespace ptdecl::TryCatchHandler {
...
namespace sig {
inline constexpr reg::Arg __construct_args[] = { reg::typed("statementsHandler", 0, "PHPStan\\Analyser\\StatementsHandler") };

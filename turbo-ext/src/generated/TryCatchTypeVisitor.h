 ...
 * src/Parser/TryCatchTypeVisitor.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_TRY_CATCH_TYPE_VISITOR_H
#define PHPSTANTURBO_GENERATED_TRY_CATCH_TYPE_VISITOR_H

#include "../reg.h"

namespace ptdecl::TryCatchTypeVisitor {

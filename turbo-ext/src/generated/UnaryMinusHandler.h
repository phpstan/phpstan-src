 ...
 * src/Analyser/ExprHandler/UnaryMinusHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_UNARY_MINUS_HANDLER_H
#define PHPSTANTURBO_GENERATED_UNARY_MINUS_HANDLER_H

#include "../reg.h"

namespace ptdecl::UnaryMinusHandler {

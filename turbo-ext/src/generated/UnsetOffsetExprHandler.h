 ...
 * src/Analyser/ExprHandler/Virtual/UnsetOffsetExprHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_UNSET_OFFSET_EXPR_HANDLER_H
#define PHPSTANTURBO_GENERATED_UNSET_OFFSET_EXPR_HANDLER_H

#include "../reg.h"

namespace ptdecl::UnsetOffsetExprHandler {

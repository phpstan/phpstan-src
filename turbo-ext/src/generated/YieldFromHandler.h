 ...
 * src/Analyser/ExprHandler/YieldFromHandler.php — do not edit. */

#ifndef PHPSTANTURBO_GENERATED_YIELD_FROM_HANDLER_H
#define PHPSTANTURBO_GENERATED_YIELD_FROM_HANDLER_H

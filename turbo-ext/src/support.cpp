...
static const pt_class_template pt_class_templates[PT_CLASS_COUNT] = {
	...
	/* PT_CLASS_SMALLER_EXPR */ {"smallerExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Smaller"},
	/* PT_CLASS_SMALLER_OR_EQUAL_EXPR */ {"smallerOrEqualExpr", "PhpParser\\Node\\Expr\\BinaryOp\\SmallerOrEqual"},
	/* PT_CLASS_GREATER_EXPR */ {"greaterExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Greater"},
	/* PT_CLASS_GREATER_OR_EQUAL_EXPR */ {"greaterOrEqualExpr", "PhpParser\\Node\\Expr\\BinaryOp\\GreaterOrEqual"},
	/* PT_CLASS_EQUAL_EXPR */ {"equalExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Equal"},
	/* PT_CLASS_NOT_EQUAL_EXPR */ {"notEqualExpr", "PhpParser\\Node\\Expr\\BinaryOp\\NotEqual"},
	/* PT_CLASS_LOGICAL_XOR_EXPR */ {"logicalXorExpr", "PhpParser\\Node\\Expr\\BinaryOp\\LogicalXor"},
	/* PT_CLASS_SPACESHIP_EXPR */ {"spaceshipExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Spaceship"},
	/* PT_CLASS_CONCAT_EXPR */ {"concatExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Concat"},
	/* PT_CLASS_BITWISE_AND_EXPR */ {"bitwiseAndExpr", "PhpParser\\Node\\Expr\\BinaryOp\\BitwiseAnd"},
	/* PT_CLASS_BITWISE_OR_EXPR */ {"bitwiseOrExpr", "PhpParser\\Node\\Expr\\BinaryOp\\BitwiseOr"},
	/* PT_CLASS_BITWISE_XOR_EXPR */ {"bitwiseXorExpr", "PhpParser\\Node\\Expr\\BinaryOp\\BitwiseXor"},
	/* PT_CLASS_DIV_EXPR */ {"divExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Div"},
	/* PT_CLASS_MOD_EXPR */ {"modExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Mod"},
	/* PT_CLASS_MUL_EXPR */ {"mulExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Mul"},
	/* PT_CLASS_POW_EXPR */ {"powExpr", "PhpParser\\Node\\Expr\\BinaryOp\\Pow"},

...
$stringOthers = static fn (string $string, string $constString, string $classString, string $genericClassString): array => [
	...
	'genericArguments' => new $genericClassString(new \PHPStan\Type\Generic\GenericObjectType(\ArrayIterator::class, [new \PHPStan\Type\IntegerType(), new \PHPStan\Type\StringType()])),
...
];
{
	...
	$subjects = [
		...
		'constArrayIterator' => new $constStringClass('arrayiterator', true),
